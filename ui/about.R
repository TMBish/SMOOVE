div(class="key-info-box pad-15 smooveinfo",
  ...
  fluidRow(
  	...
  	column(7,
		...
		HTML("
		<p> I named this project after the one and only J-Smoove. The resilience and stoicism of my NBA fandom was forged in the furnace
		...
		would be one best 4/5s in the league. Elite finishing, shot blocking, and passing at 6'9\": he had the potential to be a more offensively talented, athletic Draymond Green. </p>

		<p> I hope <b> V1 </b> of this project replaces my 10-20 daily basketball reference searches. It intends to provide a more usable, visual, and compact implementation
